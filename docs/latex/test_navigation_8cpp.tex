...
\begin{DoxyCompactList}\small\item\em Test to check the output of calculate function converges with the set\+Point and Heading. \end{DoxyCompactList}\end{DoxyCompactItemize}
